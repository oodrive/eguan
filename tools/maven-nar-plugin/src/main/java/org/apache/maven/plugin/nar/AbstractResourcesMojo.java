    ...
    extends AbstractCompileMojo
{
        ...
        throws IOException, MojoExecutionException, MojoFailureException
    {
        ...
        if ( includeDir.exists() )
        {
            ...
            copied += NarUtil.copyDirectoryStructure( includeDir, includeDstDir, null, NarUtil.DEFAULT_EXCLUDES, getLog() );
        }
        ...
        throws IOException, MojoExecutionException, MojoFailureException
    {
        ...
        if ( binDir.exists() )
        {
            ...
            copied += NarUtil.copyDirectoryStructure( binDir, binDstDir, null, NarUtil.DEFAULT_EXCLUDES, getLog() );
        }
        ...
        throws MojoFailureException, IOException, MojoExecutionException
    {
        ...
        if ( libDir.exists() )
        {
            ...
            for ( Iterator i = getLibraries().iterator(); i.hasNext(); )
            {
                ...
                copied += NarUtil.copyDirectoryStructure( libDir, libDstDir, includes, NarUtil.DEFAULT_EXCLUDES, getLog() );
            }
        }
