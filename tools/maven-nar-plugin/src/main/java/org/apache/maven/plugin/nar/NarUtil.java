        ...
        throws IOException
    {
        ...
        for ( Iterator i = files.iterator(); i.hasNext(); )
        {
            ...
            if ( Files.isSymbolicLink( pathFile ) )
            {
                ...
                Path linkTarget = Files.readSymbolicLink( pathFile );
                log.debug( "Create symbolic link: " + destination + ", target=" + linkTarget );
            ...
            else if ( file.isFile() )
            {
                ...
                log.debug( "Copy file " + pathFile + " to " + destination );
            ...
            else if ( file.isDirectory() )
            {
                ...
                copied += copyDirectoryStructure( file, destination, includes, excludes, log );
            }
            else
            {
