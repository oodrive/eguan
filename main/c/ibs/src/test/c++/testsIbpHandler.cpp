...
class testsIbpHandler: public ::testing::Test {
    protected:
        size_t before;
        size_t after;
...
TEST_F(testsIbpHandler, BasicIbpHandlerPutGetMemCheck) {
    std::string cfgFile = testsTools::InitConfig(2, OnlyColdData);
