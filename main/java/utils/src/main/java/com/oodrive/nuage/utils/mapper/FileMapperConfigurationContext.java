...
import com.oodrive.nuage.configuration.ConfigKey;
import com.oodrive.nuage.configuration.ConfigurationContext;
...
public class FileMapperConfigurationContext extends AbstractConfigurationContext {
    ...
    protected static final String NAME = "com.oodrive.nuage.filemapping";
