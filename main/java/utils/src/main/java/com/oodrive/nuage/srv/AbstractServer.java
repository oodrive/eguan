...
public abstract class AbstractServer<S extends Callable<Void>, T extends DeviceTarget, K extends AbstractServerConfig>
     ...
     * (non-Javadoc)
     * 
     * @see com.oodrive.nuage.srv.AbstractServerMXBean#getAddress()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.oodrive.nuage.srv.AbstractServerMXBean#setAddress(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.oodrive.nuage.srv.AbstractServerMXBean#getPort()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.oodrive.nuage.srv.AbstractServerMXBean#setPort(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.oodrive.nuage.srv.AbstractServerMXBean#isRestartRequired
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.oodrive.nuage.srv.AbstractServerMXBean#start()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.oodrive.nuage.srv.AbstractServerMXBean#stop()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.oodrive.nuage.srv.AbstractServerMXBean#isStarted()
     */
    @Override
