...
public final class LogUtils {
    ...
    private static final String SYSLOG_ENABLE_STR = "com.oodrive.nuage.log.enableSyslog";
    ...
    /**
     * Initialize the syslog appender for logback. Use the system property com.oodrive.nuage.log.enableSyslog to
