...
import com.oodrive.nuage.utils.UuidCharSequence;
...
public final class TestFileMappers {
    ...
    public void cleanConfig() throws Exception {
        if (tempBaseDir != null) {
            com.oodrive.nuage.utils.Files.deleteRecursive(tempBaseDir.toPath());
        }
    }
    ...
    public void testConfig6x5() throws Exception {
        final String config = "com.oodrive.nuage.filemapping.dir.prefix.length=6\ncom.oodrive.nuage.filemapping.dir.structure.depth=5";
    ...
    public void testConfig1x5() throws Exception {
        final String config = "com.oodrive.nuage.filemapping.dir.prefix.length=1\ncom.oodrive.nuage.filemapping.dir.structure.depth=5";
        final MetaConfiguration configuration = MetaConfiguration.newConfiguration(
                new ByteArrayInputStream(config.getBytes()), FileMapperConfigurationContext.getInstance());
        final FileMapper fileMapper = FileMapper.Type.DEEP.newInstance(tempBaseDir, 32, configuration);
    ...
    public void testConfig5x1() throws Exception {
        final String config = "com.oodrive.nuage.filemapping.dir.prefix.length=5\ncom.oodrive.nuage.filemapping.dir.structure.depth=1";
        final MetaConfiguration configuration = MetaConfiguration.newConfiguration(
                new ByteArrayInputStream(config.getBytes()), FileMapperConfigurationContext.getInstance());
        final FileMapper fileMapper = FileMapper.Type.DEEP.newInstance(tempBaseDir, 32, configuration);
    ...
    public void testConfig4x8() throws Exception {
        final String config = "com.oodrive.nuage.filemapping.dir.prefix.length=4\ncom.oodrive.nuage.filemapping.dir.structure.depth=8";
