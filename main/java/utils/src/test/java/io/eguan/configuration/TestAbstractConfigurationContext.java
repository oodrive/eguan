...
import static io.eguan.configuration.EnumTestValue.TEST_VALUE_1;
...
public final class TestAbstractConfigurationContext {
     ...
     */
    private static final String[] VALID_CONTEXT_NAMES = new String[] { "i", "io", "io.eguan",
            "io.eguan.c.configuration", "io.1eguan.2test" };
     ...
     */
    private static final String[] INVALID_CONTEXT_NAMES = new String[] { null, "", " ", ".", "IO", "io..eguan.test",
            "io.eguan.", "io.eguan..", "io.EGUAN.test", "io.eguan?.test" };
    ...
    public final void testCreateAbstractConfigurationContextFailNoContext() throws IllegalArgumentException,
            NullPointerException {
        new AbstractConfigurationContext("io.eguan.java.utils.config.test", new AbstractConfigKey[] {}) {
        };
    }
