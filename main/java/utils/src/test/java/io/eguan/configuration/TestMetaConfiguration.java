...
import static io.eguan.configuration.ConfigTestContext.TEST_BOOLEAN_KEY;
import static io.eguan.configuration.ConfigTestContext.TEST_ENUM_KEY;
import static io.eguan.configuration.ConfigTestContext.TEST_FILE_KEY;
import static io.eguan.configuration.ConfigTestContext.TEST_POS_INT_KEY;
import static io.eguan.configuration.ConfigTestContext.TEST_UNDEFINED_KEY;
...
import io.eguan.configuration.Configuration;
...
public final class TestMetaConfiguration {
    ...
    public final void testCreateMetaConfigurationFailDuplicateKeysInInput() throws ConfigValidationException,
        ...
        try (ByteArrayOutputStream output = new ByteArrayOutputStream();
            ...
            writer.append("io.eguan.test.key.one = foo");
            writer.newLine();
            writer.append("io.eguan.test.key.two = bar");
            writer.newLine();
            writer.append("io.eguan.test.key.two = bar2");
            writer.newLine();
            writer.append("io.eguan.test.key.one = foo2");
            writer.newLine();
            writer.append("io.eguan.test.key.one = foo3");
            writer.newLine();
            writer.flush();
    ...
    public final void testCreateMetaConfigurationFailConfigContextName() throws IOException, ConfigValidationException,
        ...
        final AbstractConfigurationContext testBadlyNamedContext = new AbstractConfigurationContext(
                "io.eguan.java.utils.test..bad", ConfigTestContext.TEST_ENUM_KEY) {
        };
    ...
    public final void testGetUnmanagedKeys() throws IOException, ConfigValidationException, RuntimeException {
        // initializes the configuration
        final Properties testConfiguration = ConfigTestHelper.getDefaultTestConfiguration();
        final String unmgtKey1 = "io.eguan.java.utils.configuration.test.unmanaged1";
        final String unmgtKey2 = "io.eguan.java.utils.configuration.test.unmanaged2";
    ...
    private static final class BadConfigContext extends AbstractConfigurationContext {
        ...
        private static final String BADLY_CHOSEN_NAME = "io.eguan.java.utils.configuration.test.bad.choice";
