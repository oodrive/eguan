...
public class Main {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        {
            final ObjectName mxbeanName = new ObjectName("com.oodrive.nuage.iscsisrv:type=iSCSIsrv");
        ...
        // target controller
        {
            ...
            final ObjectName mxbeanName = new ObjectName("com.oodrive.nuage.iscsisrv:type=iSCSItgt");
