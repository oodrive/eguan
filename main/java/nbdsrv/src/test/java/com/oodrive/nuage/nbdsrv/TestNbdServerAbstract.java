...
import com.oodrive.nuage.srv.TestAbstractServer;
...
public abstract class TestNbdServerAbstract extends
    ...
    private static String TARGET_NAME = "test-nuage";
    private static String TARGET_NAME_UPPERCASE = "TEST-NUAGE";
    private static String BAD_TARGET_NAME = "bad-test-nuage";
