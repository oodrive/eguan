...
import com.oodrive.nuage.dtx.DtxTaskAdm;
...
import com.oodrive.nuage.vvr.repository.core.api.VersionedVolumeRepository;
import com.oodrive.nuage.vvr.repository.core.api.VersionedVolumeRepository.ItemChangedEvent;
import com.oodrive.nuage.vvr.repository.core.api.VersionedVolumeRepository.ItemCreatedEvent;
import com.oodrive.nuage.vvr.repository.core.api.VersionedVolumeRepository.ItemDeletedEvent;
...
final class Vvr implements VvrMXBean, NotificationEmitter {
     ...
     * 
     * @see com.oodrive.nuage.vold.model.VvrMXBean#getUuid()
     */
    @Override
