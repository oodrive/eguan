...
import static com.oodrive.nuage.dtx.DtxResourceManagerState.UNREGISTERED;
...
public final class VvrManager implements VvrManagerMXBean, MsgServerHandler {
    ...
    static final class VvrPurger extends ThreadPoolExecutor {
        ...
        private static final String THREAD_COUNT_PROPERTY = "com.oodrive.nuage.vold.purgeThreadCount";
