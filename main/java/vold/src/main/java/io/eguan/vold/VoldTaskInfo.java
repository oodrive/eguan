...
/**
 * Immutable representation of a Vold manager task submitted to a DTX cluster. This version is exported as a MXBean
 * attribute.
 * 
 * @author oodrive
 * @author jmcaba
 */
@Immutable
public final class VoldTaskInfo extends DtxTaskInfo {

    private final VoldTaskOperation operation;
    private final VoldTargetType targetType;
    private final String targetId;

    /**
     * Constructs information for vold manager task.
     * 
     * @param resourceId
    ...
    public VoldTaskInfo(@Nonnull final String source, @Nonnull final VoldTaskOperation operation,
            @Nonnull final VoldTargetType targetType, final String targetId) {
        super(source);
