...
import static com.oodrive.nuage.ibs.IbsTestDefinitions.COMPRESSION_KEYWORD;
import static com.oodrive.nuage.ibs.IbsTestDefinitions.CONF_DEBUG_LEVEL;
        ...
        void finiIbs() throws Exception {
            ...
            if (this.tempFileConfig != null) {
                if (this.tempFileConfig.isFile()) {
                    ...
                    com.oodrive.nuage.utils.Files.deleteRecursive(this.tempFileConfig.toPath());
                }
            ...
            if (this.tempDirIbpgen != null) {
                try {
                    com.oodrive.nuage.utils.Files.deleteRecursive(this.tempDirIbpgen);
                }
            ...
            if (this.tempDirIbp != null) {
                try {
                    com.oodrive.nuage.utils.Files.deleteRecursive(this.tempDirIbp);
                }
                catch (final IOException e) {
