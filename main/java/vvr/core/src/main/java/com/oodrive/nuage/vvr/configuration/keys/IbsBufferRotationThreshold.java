 ...
 * <tr>
 * <td>{@value #NAME}</td>
 * <td>Buffer rotation threshold, mapped to {@value #IBS_CONFIG_KEY} in the IBS configuration file.</td>
 * <td>FALSE</td>
 ...
 * 
 */
public final class IbsBufferRotationThreshold extends PositiveIntegerConfigKey implements IbsConfigKey {

    private static final String NAME = "ldb.bufferrotationthreshold";

    private static final String IBS_CONFIG_KEY = "buffer_rotation_threshold";

    private static final int MAX_VALUE = Integer.MAX_VALUE;

    private static final int DEFAULT_VALUE = 65536;

    private static final IbsBufferRotationThreshold INSTANCE = new IbsBufferRotationThreshold();

    public static IbsBufferRotationThreshold getInstance() {
        return INSTANCE;
    }

    private IbsBufferRotationThreshold() throws IllegalArgumentException {
