...
@Immutable
public final class VvrTaskInfo extends DtxTaskInfo {

    private final VvrTaskOperation operation;
    private final VvrTargetType targetType;
    ...
    public VvrTaskInfo(@Nonnull final String source, @Nonnull final VvrTaskOperation operation,
            @Nonnull final VvrTargetType targetType, final String targetId) {
        super(source);
     ...
     */
    public final VvrTaskOperation getOperation() {
