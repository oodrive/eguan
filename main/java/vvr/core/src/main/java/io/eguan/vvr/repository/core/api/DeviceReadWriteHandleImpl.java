...
public abstract class DeviceReadWriteHandleImpl implements ReadWriteHandle {
    ...
    private static final boolean SINGLE_THREADED = Boolean.getBoolean("io.eguan.vvr.io.singleThreaded");
     ...
     * (non-Javadoc)
     * 
     * @see io.eguan.vvr.repository.core.api.Device.ReadWriteHandle#read(io.eguan.vvr.io.ByteDataSink,
     * int, int, long)
     */
    @Override
     ...
     * 
     * @see
     * io.eguan.vvr.repository.core.api.Device.ReadWriteHandle#write(io.eguan.vvr.io.ByteDataSource,
     * int, int, long)
     */
    @Override
     ...
     * 
     * @see
     * io.eguan.vvr.repository.core.api.Device.ReadWriteHandle#trim(io.eguan.vvr.io.ByteDataSource,
     * int, int, long)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see io.eguan.vvr.repository.core.api.Device.ReadWriteHandle#getSize()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see io.eguan.vvr.repository.core.api.Device.ReadWriteHandle#getBlockSize()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see io.eguan.vvr.repository.core.api.Device.ReadWriteHandle#close()
     */
    @Override
