...
import com.oodrive.nuage.vvr.configuration.keys.IbsAutoConfRamSize;
import com.oodrive.nuage.vvr.configuration.keys.IbsBufferRotationDelay;
import com.oodrive.nuage.vvr.configuration.keys.IbsBufferRotationThreshold;
import com.oodrive.nuage.vvr.configuration.keys.IbsBufferWriteDelayIncrement;
import com.oodrive.nuage.vvr.configuration.keys.IbsBufferWriteDelayLevelSize;
import com.oodrive.nuage.vvr.configuration.keys.IbsBufferWriteDelayThreshold;
import com.oodrive.nuage.vvr.configuration.keys.IbsCompressionConfigKey;
import com.oodrive.nuage.vvr.configuration.keys.IbsCompressionValue;
import com.oodrive.nuage.vvr.configuration.keys.IbsConfigKey;
import com.oodrive.nuage.vvr.configuration.keys.IbsDisableBackgroundCompactionForIbpgenConfigKey;
import com.oodrive.nuage.vvr.configuration.keys.IbsDumpAtStopBestEffortDelayConfigKey;
...
import com.oodrive.nuage.vvr.configuration.keys.IbsLdbBlockRestartIntervalConfigKey;
import com.oodrive.nuage.vvr.configuration.keys.IbsLdbBlockSizeConfigKey;
import com.oodrive.nuage.vvr.configuration.keys.IbsLogLevel;
...
import com.oodrive.nuage.vvr.configuration.keys.IbsRecordExecutionConfigKey;
import com.oodrive.nuage.vvr.configuration.keys.IbsSyslogConfigKey;
import com.oodrive.nuage.vvr.configuration.keys.IbsUuidConfigKey;
...
public final class TestValidIbsConfigurationContext extends ValidConfigurationContext {
    ...
    private static class ContextTestHelperIbs extends ContextTestHelper<IbsConfigurationContext> {
        ...
        public void tearDown() throws InitializationError {
            try {
                com.oodrive.nuage.utils.Files.deleteRecursive(ibsIbpGenDir.toPath());

                for (final File currFile : ibsIbpDirList) {
                    com.oodrive.nuage.utils.Files.deleteRecursive(currFile.toPath());
                }
            }
            catch (final IOException e) {
                throw new InitializationError(e);
    ...
    private static final class ContextTestHelperIbsError extends ContextTestHelperIbs {
        ...
        public void tearDown() throws InitializationError {
            ...
            try {
                com.oodrive.nuage.utils.Files.deleteRecursive(ibpDirParent.toPath());
            }
            catch (final IOException e) {
                throw new InitializationError(e);
            }
