...
public class TargetSession {
      ...
      // OODRIVE
//    private static final Logger LOGGER = LoggerFactory.getLogger(TargetSession.class); //OODRIVE
     ...
     */
    // private final Connection connection; // OODRIVE 
    ...
    /**
     * The TSIH used by the initiator for identifying this session.
     */
    private short initiatorSessionHandle ;
    ...
    public TargetSession(final TargetServer target, final Connection connection,
        final ISID initiatorSessionID, final int expectedCommandSequenceNumber, final int statusSequenceNumber, int cid, short tsih) {
        ...
        setInitiatorSessionHandle(tsih) ;
     ...
     */
    // OODRIVE     public Connection getConnection() {
    // OODRIVE         return connection;
    // OODRIVE     }
     ...
     */
    // OODRIVE     public Target getTarget() {
    // OODRIVE         return target;
    // OODRIVE     }
    ...
    void removeTargetConnection(Connection connection) {
        ...
        targetServer.removeTargetConnection((TargetConnection) connection);
    }
     ...
     */
    public final boolean setSessionType(SessionType sessionType) {// OODRIVE change to public
    ...
    public void setTargetName(String targetName) {
        ...
        deviceIdentificationVpdPage = null;
    }
    ...
    private volatile DeviceIdentificationVpdPage deviceIdentificationVpdPage;

    public DeviceIdentificationVpdPage getDeviceIdentificationVpdPage() {
        // Lazy init of deviceIdentificationVpdPage
        DeviceIdentificationVpdPage deviceIdentificationVpdPageTmp = deviceIdentificationVpdPage;
        if (deviceIdentificationVpdPageTmp == null && target != null) {
            deviceIdentificationVpdPageTmp = new DeviceIdentificationVpdPage(target);
            deviceIdentificationVpdPage = deviceIdentificationVpdPageTmp;
        }
        return deviceIdentificationVpdPageTmp;
    }

    public short getInitiatorSessionHandle() {
        return initiatorSessionHandle;
    }

    public void setInitiatorSessionHandle(short sessionHandle) {
        this.initiatorSessionHandle = sessionHandle;
    }
}
