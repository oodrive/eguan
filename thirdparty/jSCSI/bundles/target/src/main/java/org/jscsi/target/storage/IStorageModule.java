...
public interface IStorageModule {
     ...
     * 
     * @return <code>true</code> if the storage space is write protected
     */
     ...
     * @throws IOException
     */
    void read(ByteBuffer bytes, long storageIndex) throws IOException;
     ...
     * @throws IOException
     */
    void write(ByteBuffer bytes, long storageIndex) throws IOException;
