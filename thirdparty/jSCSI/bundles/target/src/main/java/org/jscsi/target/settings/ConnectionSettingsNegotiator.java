...
public final class ConnectionSettingsNegotiator extends SettingsNegotiator {
     ...
     *         problem
     */
    public boolean negotiate(TargetSession session, final LoginStage loginStage,
        final  TargetConnection connection, final boolean initialPdu, final List<String> requestKeyValuePairs,
        ...
        while (keys.size() > 0) {
            ...
            if (entry == null) {
                ...
                everythingOkay &=
                    entry.negotiate(target, loginStage, connection.isLeadingConnection(), initialPdu, keys.get(0), values
        ...
        if (initialPdu) {
            ...
            if (normalSession) {
                ...
                if (targetName == null || // not declared
                    !target.isValidTargetName(targetName) || !target.checkSessionParameters(connection, targetName))
