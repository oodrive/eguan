...
public class DeviceIdentificationVpdPage implements IResponseData {
    ...
    private final IdentificationDescriptor[] identificationDescriptors;

    public DeviceIdentificationVpdPage(Target target) {
        ...
        String targetName = target.getTargetName(); // OODRIVE
        identificationDescriptors = new IdentificationDescriptor[1];
        // OODRIVE for (int curTargetNum = 0; curTargetNum < targetNames.length; curTargetNum++) {
            final IdentificationDescriptor identDescriptor =
                new IdentificationDescriptor(protocolIdentifier, codeSet, protocolIdentifierValid,
                    association, identifierType, new ScsiNameStringIdentifier(targetName));
